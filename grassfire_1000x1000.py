...
def main():
    ...
    # 1) Map
    print("Generating 1000x1000 map with random obstacles...")
    ...
    # 3) Skeleton
    print("Computing medial-axis skeleton...")
    ...
    # 4) Graph + path
    print("Building skeleton graph and finding optimal path...")
    ...
    print("Generating final path visualization...")
    ...
    print("\n" + "="*60)
    print("PATH PLANNING RESULTS (1000×1000 Grid)")
    print("="*60)
    ...
    print(f"\nObstacles: {NUM_RECTS} random rectangles")
    print(f"Start: {start}")
    print(f"Goal: {goal}")
    print("\nOutput Files:")
